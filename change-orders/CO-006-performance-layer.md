...
- Phase 4: NEXT — W6 settings complete (reduced-motion toggle mirroring the media query, performance mode disabling grain/glow/shadows, operator callsign in comms addressing, boot-skip toggle), mix/timing polish pass, reduced-motion audit, then the full §4 acceptance sweep.
